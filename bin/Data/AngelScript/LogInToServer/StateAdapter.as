...
namespace LogInToServer
{
    ...
    {        
        ...
        {
            String nickname = stateUi.get_nickname();
            nickname.Replace ('!', '_');
            nickname.Replace ('(', '_');
            nickname.Replace (')', '_');
            nickname.Replace ('[', '_');
            ...
            network.Connect (stateUi.get_adress(), stateUi.get_port(), SharedGlobals::syncedGameScene);
            isConnectingNow = true;
            stateUi.SetConnectionSetupFieldsVisible (false);
            
            SharedGlobals::lastAdress = stateUi.get_adress();
            SharedGlobals::lastPort = stateUi.get_port();
        ...
        {
            ErrorDialog ("Connect failed!", "Connection to " + stateUi.get_adress() + ":" + 
                         stateUi.get_port() + " failed!");
            engine.Exit ();
        }
        ...
        {
            ErrorDialog ("Error loading scene!", "Connection to " + stateUi.get_adress() + ":" +
